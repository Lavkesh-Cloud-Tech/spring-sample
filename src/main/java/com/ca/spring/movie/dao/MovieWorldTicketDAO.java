...
public class MovieWorldTicketDAO {
	...
	public void saveReservationDetails(final TicketVO ticketVO) throws MovieWorldException {
		...
		Object[] ticketAvailableSqlArgs = new Object[] { movieCode, ticketClass, dateStr, time };
	...
	private void checkMovieExistWhileBooking(String movieCode, String ticketClass, String dateStr, String time)
		...
		Object[] findMovieTicketClassExistArgs = new Object[] { movieCode, ticketClass, dateStr, time };
